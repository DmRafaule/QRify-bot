...
* Convert an input text into a QR code.
* Convert images with QR codes into text.
* Inline mode: This means you can use this bot in any chat to be able to convert your text into a QR code.